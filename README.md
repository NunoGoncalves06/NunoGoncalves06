...
- **Programming languages:** Java, Kotlin, Python, C, C++
- **Networking:** routing, switching and network fundamentals (CCNA)
- **Security:** CTFs, mostly forensics, reverse engineering, pwn and misc; CEH training completed
- **Cloud:** AWS fundamentals (Cloud Practitioner training completed)
- **Tools:** Git and GitHub, Linux, Wireshark, Burp Suite, Hydra
...
- **Email:** nunogoncalves070906@gmail.com
